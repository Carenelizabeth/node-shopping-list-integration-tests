...
describe('Recipes', function(){
  ...
  it('Should display recipe name, id and ingredients on GET', function(){
  ...
  it('Should add a recipe on POST', function(){
    const newRecipe = {name: 'banana split', ingredients: ['bananas', 'ice cream', 'hot fudge']};
  ...
  it('Should update recipe on PUT', function(){
    const updateRecipe = {name: 'taco salad', ingredients: ['lettuce', 'ground beef', 'salsa', 'tortilla chips']};
    return chai.request(app)
      .get('/recipes')
      .then(function(res){
